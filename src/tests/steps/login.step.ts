...
When('customer provides wrong {string} as username', async function (name: string) {
...
Then('error message is shown', async function () {
  ...
  await loginPage.assertErrorMessage('Error: Incorrect login or password provided.');
});
